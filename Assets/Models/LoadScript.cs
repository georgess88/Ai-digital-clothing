...
public class LoadScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        GameObject.Find("CleftEye").gameObject.transform.position=new Vector3(-dict["leftEyeX"]+dict["rangeX"],-dict["leftEyeY"]+dict["rangeY"],390);
        GameObject.Find("CrightEye").gameObject.transform.position=new Vector3(-dict["rightEyeX"]+dict["rangeX"],-dict["rightEyeY"]+dict["rangeY"],390);
        GameObject.Find("CleftShoulder").gameObject.transform.position=new Vector3(-dict["leftShoulderX"]+dict["rangeX"],-dict["leftShoulderY"]+dict["rangeY"],390);
        GameObject.Find("CrightShoulder").gameObject.transform.position=new Vector3(-dict["rightShoulderX"]+dict["rangeX"],-dict["rightShoulderY"]+dict["rangeY"],390);
    }
}
